...
def leads_kanban(request):
    return render(request, 'pages/crm/leads-kanban.html')

def leads_details(request):
    return render(request, 'pages/crm/leads-details.html')
...
def profile(request):
    return render(request, 'pages/settings/general-settings/profile.html')
